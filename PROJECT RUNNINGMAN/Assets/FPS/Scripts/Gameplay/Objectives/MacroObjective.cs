...
{
    public class MacroObjective : Objective
    {
        [Tooltip("Choose whether you need to kill every enemy or if you can escape")]
        public bool MustKillAllEnemies = true;

        [Tooltip("If MustKillAllEnemies is true, this is the amount of enemy kills required")]
