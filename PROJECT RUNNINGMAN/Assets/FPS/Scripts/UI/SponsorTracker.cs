...
namespace Unity.FPS.UI
{
    ...
    public class SponsorTracker : MonoBehaviour
    {
        [Tooltip("CanvasGroup to fade the ammo UI")]
        public CanvasGroup CanvasGroup;

        [Tooltip("Image for the sponsorship icon")] public Image SponsorImage;

        [Tooltip("Image component for the background")]
        public Image SponsorBackgroundImage;

        [Tooltip("Image component to display fill ratio")]
        public Image SponsorFillImage;
        ...
        public void Initialize(WeaponController weapon, int weaponIndex)
        {
            ...
            SponsorImage.sprite = weapon.WeaponIcon;
        ...
        void Update()
        {
            ...
            SponsorFillImage.fillAmount = Mathf.Lerp(SponsorFillImage.fillAmount, currenFillRatio,
